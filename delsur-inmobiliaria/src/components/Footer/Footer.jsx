...
const Footer = () => {
  ...
  return (
    <div className='footer'>
      <Avatar size="x2" src="../src/assets/images/logo.png"/>

      <div className='social-icons-container'>
        <h2 className='link-title'>Redes sociales:</h2>
        <a href="https://www.instagram.com/delsur.inmobiliaria/" target='blank' className='social-icon'></a>
        <a href="https://www.facebook.com/delsurinmobiliaria" target='blank' className='social-icon'></a>
        <a href="https://api.whatsapp.com/send?phone=541151822809&text=&source=&data=&app_absent=" target='blank' className='social-icon'></a>
      </div>
      ...
      <iframe className='maps' src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3272.992631351957!2d-58.17429965416357!3d-34.88153134631936!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x95a2d9ce90a49991%3A0x3f74384004a41188!2sDel%20Sur%20Inmobiliaria!5e0!3m2!1ses!2sar!4v1691772175516!5m2!1ses!2sar" allowFullScreen="" loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
